...
const galleryImages = [
  {
    ...
    category: "ceremonies",
    description: "Commander General and officials during important meeting",
  },
  {
    id: 2,
    src: cg,
    ...
    category: "official",
    description: "Portrait of the Commander General of NUPEC",
  },
  {
    id: 3,
    src: cgAndMember,
    ...
    category: "official",
    description: "NUPEC leadership engagement with members",
  },
  {
    id: 4,
    src: batch,
    title: "Commissioning Batch",
    category: "ceremonies",
    description: "New batch of officers being commissioned",
  },
  {
    id: 5,
    src: mg3196,
    ...
    category: "training",
    description: "Officers during field training exercises",
  },
  {
    id: 6,
    src: mg3193,
    ...
    category: "training",
    description: "Cadets undergoing rigorous training",
  },
  {
    id: 7,
    src: mg3168c,
    ...
    category: "training",
    description: "Operational briefing and planning session",
  },
  {
    id: 8,
    src: mg3166c,
    ...
    category: "community",
    description: "NUPEC officers engaging with local community",
  },
  {
    id: 9,
    src: mg3166,
    ...
    category: "training",
    description: "Officers during field deployment exercise",
  },
  {
    id: 10,
    src: mg3165,
    title: "Training Exercise",
    category: "training",
    description: "Physical training exercises for cadets",
  },
  {
    id: 11,
    src: mg3163,
    ...
    category: "training",
    description: "Specialized operations training session",
  },
  {
    id: 12,
    src: mg3160,
    ...
    category: "ceremonies",
    description: "Official ceremonial event with honors",
  },
];
